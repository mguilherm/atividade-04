...
function montarPalco() {
    ...
    for (var i = 1; i <= POLTRONAS; i++) {
        ...
        if (ocupadas.indexOf(i.toString()) >= 0) {
            imgStatus.src = "./img/reservas/poltrona-red.svg"; //  ocupada
        } else {
            imgStatus.src = "./img/reservas/poltrona-green.svg"; // disponivel
        }
...
function reservarPoltrona() {
    ...
    imgPoltrona.src = "./img/reservas/poltrona-gray.svg";
...
function confirmarReserva() {
    ...
    for (var i = 0; i < reservadas.length; i++) {
        ...
        imgPoltrona.src = "./img/reservas/poltrona-red.svg";
    }
